...
static void DescribeAlgorithmComponent_ScatterGather( AAX_IComponentDescriptor* outDesc )
{
	...
	err = properties->AddProperty ( AAX_eProperty_ProductID, cDemoGain_ProductID_ScatterGather );
...
static void DescribeAlgorithmComponent_Burst( AAX_IComponentDescriptor * outDesc )
{
	...
	//
	// Burst properties
	err = properties->AddProperty ( AAX_eProperty_ProductID, cDemoGain_ProductID_Burst );
