...
static AAX_Result DescribeEffect( AAX_IEffectDescriptor* outDescriptor )
{
	...
	// Effect identifiers
	//
	err = outDescriptor->AddName ( "Demo Gain (PTSL)" );
	err = outDescriptor->AddName ( "Demo Gain PTSL" );
	err = outDescriptor->AddName ( "Demo Gain PS" );
	err = outDescriptor->AddName ( "DemoGainPS" );
	err = outDescriptor->AddName ( "DmGainPS" );
	err = outDescriptor->AddName ( "DGPS" );
	err = outDescriptor->AddName ( "DP" );
...
AAX_Result GetEffectDescriptions( AAX_ICollection* outCollection )
{
	...
	err = outCollection->AddPackageName( "DemoGain (PTSL) AAX Example Plug-In" );
	err = outCollection->AddPackageName( "DemoGain (PTSL)" );
	err = outCollection->AddPackageName( "DemoGain PS" );
