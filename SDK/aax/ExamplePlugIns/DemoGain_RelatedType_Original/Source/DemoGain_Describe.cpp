...
static AAX_Result DescribeEffect( AAX_IEffectDescriptor* outDescriptor )
{
	...
	// Effect identifiers
	//
	err = outDescriptor->AddName ( "Demo Gain Original Example" );
	err = outDescriptor->AddName ( "Demo Gain Original" );
	err = outDescriptor->AddName ( "DemoGain Orig" );
	err = outDescriptor->AddName ( "DmGain Orig" );
	err = outDescriptor->AddName ( "DG Orig" );
	err = outDescriptor->AddName ( "DGOr" );
	err = outDescriptor->AddName ( "DO" );
