\hypertarget{a00933}{}\doxysection{DSH Guide}
\label{a00933}\index{DSH Guide@{DSH Guide}}
How to test basic functionality of AAX plug-\/ins using DSH test tool. 

\hypertarget{a00933_dsh_guide_contents}{}\doxysubsection{Contents}\label{a00933_dsh_guide_contents}
\begin{DoxyItemize}
\item \mbox{\hyperlink{a00933_dsh_guide_00_what_is_dsh_and_how_it_works}{What is DSH and how it works}} \item \mbox{\hyperlink{a00933_dsh_guide_01_basic_set_of_commands_of_dae_dish}{Basic set of commands of the DAE dish}} \item \mbox{\hyperlink{a00933_dsh_guide_02_basic_plugin_tests}{Basic plug-\/in tests}} \item \mbox{\hyperlink{a00933_dsh_guide_03_debugging_and_tracing}{Debugging and tracing in DSH}} \item \mbox{\hyperlink{a00933_dsh_guide_04_scripting_interface_and_batch_profiling}{Scripting interface and batch profiling}}\end{DoxyItemize}
 \hypertarget{a00933_dsh_guide_00_what_is_dsh_and_how_it_works}{}\doxysubsection{What is DSH and how it works}\label{a00933_dsh_guide_00_what_is_dsh_and_how_it_works}
...
\end{DoxyItemize}
 ...
 \hypertarget{a00933_dsh_guide_01_basic_set_of_commands_of_dae_dish}{}\doxysubsection{Basic set of commands of the DAE dish}\label{a00933_dsh_guide_01_basic_set_of_commands_of_dae_dish}
...
Another dish supplied with DSH, the aaxh dish, provides a lower-\/level hosting environment for \mbox{\hyperlink{a00950}{AAX}} plug-\/ins. This dish loads a dedicated \mbox{\hyperlink{a00950}{AAX}} host component without audio routing logic or other audio engine responsibilities. In this guide we will focus on loading and running plug-\/ins using the DAE dish, but we encourage you to also explore the commands available in the aaxh dish and to learn how to exercise your plug-\/ins in that environment.

\hypertarget{a00933_subsection__loading_plugins}{}\doxysubsubsection{Loading plug-\/ins in DSH}\label{a00933_subsection__loading_plugins}
...
-\/30xxx errors are dynamically-\/generated and can indicate different failures. Failures due to plug-\/ins exceeding the cycle limit of the DSP CPU will often appear as -\/30xxx errors. See \mbox{\hyperlink{a00930_subsection__30xxx_dynamic_error_codes}{-\/30xxx\+: Dynamically-\/generated error codes}} in the \mbox{\hyperlink{a00930}{HDX DSP Guide}} for more information.
...
\hypertarget{a00933_subsection__working_with_hdx_card_from_dsh}{}\doxysubsubsection{Working with HDX card from DSH}\label{a00933_subsection__working_with_hdx_card_from_dsh}
...
\hypertarget{a00933_subsection__dsh_tips}{}\doxysubsubsection{DAE dish tips}\label{a00933_subsection__dsh_tips}
 
\begin{DoxyItemize}
\item With the standard configuration, the system\textquotesingle{}s \mbox{\hyperlink{a00950}{AAX}} plug-\/ins folder will be used by DSH and DTT. To override this, create a folder named \char`\"{}\+Plug-\/\+Ins\char`\"{} next to the DTT and Command\+Line\+Tools directories. While that directory exists, AAE will only scan the plug-\/ins in the new Plug-\/\+Ins folder.  
\end{DoxyItemize}



 \hypertarget{a00933_dsh_guide_02_basic_plugin_tests}{}\doxysubsection{Basic plug-\/in tests}\label{a00933_dsh_guide_02_basic_plugin_tests}
...
\hypertarget{a00933_subsection__cyclessharedtest}{}\doxysubsubsection{Cycle count performance test}\label{a00933_subsection__cyclessharedtest}
...
\hypertarget{a00933_subsubsection__performance_profiling_and_test_signals_}{}\doxyparagraph{Performance profiling and test signals}\label{a00933_subsubsection__performance_profiling_and_test_signals_}
...
\hypertarget{a00933_subsection__cancellationtest}{}\doxysubsubsection{Cancellation test}\label{a00933_subsection__cancellationtest}
...
\end{DoxyEnumerate}
 ...
 \hypertarget{a00933_dsh_guide_03_debugging_and_tracing}{}\doxysubsection{Debugging and tracing in DSH}\label{a00933_dsh_guide_03_debugging_and_tracing}
...
\end{DoxyNote}
 ...
 \hypertarget{a00933_dsh_guide_04_scripting_interface_and_batch_profiling}{}\doxysubsection{Scripting interface and batch profiling}\label{a00933_dsh_guide_04_scripting_interface_and_batch_profiling}
 Digi\+Shell can be scripted using Dish\+Test\+Tool, a Ruby-\/based command line tool. More details can be found in \mbox{\hyperlink{a00934}{DTT Guide}}.
