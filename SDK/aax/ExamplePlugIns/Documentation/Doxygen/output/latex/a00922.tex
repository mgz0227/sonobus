\hypertarget{a00922}{}\doxysection{Linked parameters}
\label{a00922}\index{Linked parameters@{Linked parameters}}
How to link parameters. 

\hypertarget{a00922_linkedParameters_contents}{}\doxysubsection{On this page}\label{a00922_linkedParameters_contents}
\begin{DoxyItemize}
\item \mbox{\hyperlink{a00922_linkedParameters_basics}{Basics of Linked Parameters}} \item \mbox{\hyperlink{a00922_linkedParameters_linkedParameterOperation}{Linked Parameter Operation}} \item \mbox{\hyperlink{a00922_linkedParameters_changingTapers}{Changing Tapers}}\end{DoxyItemize}
\hypertarget{a00922_linkedParameters_basics}{}\doxysubsection{Basics of Linked Parameters}\label{a00922_linkedParameters_basics}
...
\end{DoxyItemize}\hypertarget{a00922_linkedParameters_considerations}{}\doxysubsubsection{Basic considerations for parameter linking}\label{a00922_linkedParameters_considerations}
...
In all of these cases, a plug-\/in should provide consistent linked parameter behavior\+: every automated playback pass should be identical, parameters should never \char`\"{}fight\char`\"{} one another or trigger rapid and unexpected changes in other parameters, parameters should not become \char`\"{}stuck\char`\"{} in a particular state, etc.
 ...
 Here comes trouble\hypertarget{a00922_linkedParameters_behavior}{}\doxysubsubsection{Defining proper linked parameter behavior}\label{a00922_linkedParameters_behavior}
...
With those potential problems in mind, here is a description of how parameter linking {\itshape should} behave.\hypertarget{a00922_linkedParamters_behavior_correct}{}\doxyparagraph{Correct behavior for linked parameters}\label{a00922_linkedParamters_behavior_correct}
{\itshape Notes}
\begin{DoxyItemize}
...
Here is how the system works WITH linked parameters, using code snippets from the Demo\+Gain\+\_\+\+Linked\+Parameters example plug-\/in\+:\hypertarget{a00922_linkedParameters_linkedParameterOperation_userEditing}{}\doxysubsubsection{User Editing}\label{a00922_linkedParameters_linkedParameterOperation_userEditing}
...
\DoxyCodeLine{\textcolor{comment}{// *******************************************************************************}}
\DoxyCodeLine{\mbox{\hyperlink{a00410_a4d8f69a697df7f70c3a8e9b8ee130d2f}{AAX\_Result}} DemoGain\_Parameters::UpdateParameterTouch ( \mbox{\hyperlink{a00410_a1440c756fe5cb158b78193b2fc1780d1}{AAX\_CParamID}} inParameterID, \mbox{\hyperlink{a00410_aa216506530f1d19a2965931ced2b274b}{AAX\_CBoolean}} inTouchState )}
\DoxyCodeLine{\{}
\DoxyCodeLine{    \textcolor{keywordflow}{if} ( inTouchState )}
\DoxyCodeLine{    \{}
\DoxyCodeLine{        \mbox{\hyperlink{a00410_a1440c756fe5cb158b78193b2fc1780d1}{AAX\_CParamID}} linkedControl = this-\/>GetLinkedControl ( inParameterID );}
...
\item The SET token goes into the system and comes back to the plugin via \mbox{\hyperlink{a01852_aeff79c1e5cc6b65c7ed21d9912f87caf}{AAX\+\_\+\+CEffect\+Parameters\+::\+Update\+Parameter\+Normalized\+Value()}}.
\begin{DoxyItemize}
\item If the parameter is linked then the other linked parameter should have its value set for its linked behaviour. The system knows this is a linked parameter so when the value comes back to the plug-\/in via Update\+Parameter\+Normalized\+Value() it will know not to perform linked behaviors on that value change. To determine if a parameter should set a linked parameter you check it with the \mbox{\hyperlink{a01852_a7ee10904c6933cbf82b6050044fa15eb}{AAX\+\_\+\+CEffect\+Parameters\+::\+Is\+Parameter\+Touched()}} method.
\end{DoxyItemize}
...
\DoxyCodeLine{\textcolor{comment}{// *******************************************************************************}}
\DoxyCodeLine{\mbox{\hyperlink{a00410_a4d8f69a697df7f70c3a8e9b8ee130d2f}{AAX\_Result}} DemoGain\_Parameters::UpdateParameterNormalizedValue ( \mbox{\hyperlink{a00410_a1440c756fe5cb158b78193b2fc1780d1}{AAX\_CParamID}} inParameterID, \textcolor{keywordtype}{double} inValue, \mbox{\hyperlink{a00524_a30be0398faf20c6b121239eb9399f3f7}{AAX\_EUpdateSource}} inSource )}
\DoxyCodeLine{\{}
\DoxyCodeLine{    \mbox{\hyperlink{a00410_a4d8f69a697df7f70c3a8e9b8ee130d2f}{AAX\_Result}}    result = \mbox{\hyperlink{a01852_aeff79c1e5cc6b65c7ed21d9912f87caf}{AAX\_CEffectParameters::UpdateParameterNormalizedValue}} ( inParameterID, inValue, inSource );}
\DoxyCodeLine{    \textcolor{keywordtype}{bool}        touched = this-\/>IsParameterTouched ( inParameterID );}
\DoxyCodeLine{}
\DoxyCodeLine{    [...]}
\DoxyCodeLine{                \textcolor{keywordflow}{if} ( touched \&\& inSource == \mbox{\hyperlink{a00524_a30be0398faf20c6b121239eb9399f3f7aec16143f3916bad3c5a6d8eb60600a3b}{AAX\_eUpdateSource\_Unspecified}} )}
\DoxyCodeLine{                \{}
...
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{a00922_linkedParameters_linkedParameterOperation_automationPlayback}{}\doxysubsubsection{Automation Playback}\label{a00922_linkedParameters_linkedParameterOperation_automationPlayback}

\begin{DoxyEnumerate}
\item The SET token comes from the automation system and enters the plugin via \mbox{\hyperlink{a02068_a685858711efb8634ce66c327f2865c71}{Update\+Parameter\+Normalized\+Value()}}.
\begin{DoxyItemize}
...
\end{DoxyEnumerate}\hypertarget{a00922_linkedParameters_linkedParameterOperation_chunkRestoring}{}\doxysubsubsection{Chunk Restoring}\label{a00922_linkedParameters_linkedParameterOperation_chunkRestoring}
...
\end{DoxyEnumerate}\hypertarget{a00922_linkedParameters_changingTapers}{}\doxysubsection{Changing Tapers}\label{a00922_linkedParameters_changingTapers}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{a00410_a4d8f69a697df7f70c3a8e9b8ee130d2f}{AAX\_Result}} Simple\_Parameters::UpdateParameterNormalizedValue ( \mbox{\hyperlink{a00410_a1440c756fe5cb158b78193b2fc1780d1}{AAX\_CParamID}} inParameterID, \textcolor{keywordtype}{double} inValue, \mbox{\hyperlink{a00524_a30be0398faf20c6b121239eb9399f3f7}{AAX\_EUpdateSource}} inSource )}
\DoxyCodeLine{\{}
