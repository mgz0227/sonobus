\hypertarget{a00890}{}\doxysection{Real-\/time algorithm callback}
\label{a00890}\index{Real-\/time algorithm callback@{Real-\/time algorithm callback}}
A plug-\/in\textquotesingle{}s audio processing core. 

\hypertarget{a00890_algpagecontents}{}\doxysubsection{On this page}\label{a00890_algpagecontents}
\begin{DoxyItemize}
\item \mbox{\hyperlink{a00890_alg_def}{Algorithm definition}} \item \mbox{\hyperlink{a00890_alg_memmgmt}{Algorithm memory management}} \item \mbox{\hyperlink{a00890_alg_comm}{Communicating with the algorithm}} \item \mbox{\hyperlink{a00890_alg_initialization}{Algorithm initialization}} \item \mbox{\hyperlink{a00890_alg_processing}{Algorithm processing}} \item \mbox{\hyperlink{a00890_alg_pd}{Persistent algorithm memory}} \item \mbox{\hyperlink{a00890_alg_examp}{Example algorithm callback}} \item \mbox{\hyperlink{a00890_alg_porttypes}{Port Types and Behavior}} \item \mbox{\hyperlink{a00890_alg_seealso}{Additional Information}}\end{DoxyItemize}
 \hypertarget{a00890_alg_def}{}\doxysubsection{Algorithm definition}\label{a00890_alg_def}
 Algorithm processing in AAX plug-\/ins is handled via a C-\/style algorithm processing callback (see code below.) Each Effect variation in a plug-\/in must register an algorithm entrypoint in the plug-\/in \mbox{\hyperlink{a00889}{description}}, and the host will call this entrypoint to render a buffer of audio samples.


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{a00410_aaa22112139aa627574b1ef562f579d43}{AAX\_CALLBACK}} MyPlugIn\_AlgorithmProcessFunction(}
...
\end{DoxyCode}
 ...
 \hypertarget{a00890_alg_memmgmt}{}\doxysubsection{Algorithm memory management}\label{a00890_alg_memmgmt}
...
\end{DoxyCode}
 ...
 If persistent memory is required, algorithms can register for block(s) of persistent state date via the \mbox{\hyperlink{a02216_a125949841a13e97ff93fa321f2050433}{AAX\+\_\+\+IComponent\+Descriptor\+::\+Add\+Private\+Data()}} API (as in SDemo\+Dist\+\_\+\+Alg\+\_\+\+Context\+::m\+Biquads above.) A plug-\/in may store state data in the resulting {\itshape \char`\"{}private data\char`\"{}} context fields and this data will be restored by the host when the algorithm is next called. See the \mbox{\hyperlink{a00890_alg_pd}{Persistent algorithm memory}} section below for more information. 

 \hypertarget{a00890_alg_comm}{}\doxysubsection{Communicating with the algorithm}\label{a00890_alg_comm}
 ...
 This system utilizes a static data routing scheme that is defined in the plug-\/in\textquotesingle{}s describe method. Once the routing scheme has been defined, the plug-\/in may post packets of data to its algorithm using \mbox{\hyperlink{a02224_ae5dd2b5925dbc181513bca1c4ac5e716}{AAX\+\_\+\+IController\+::\+Post\+Packet()}}.

 In order to reference the fields in its algorithm\textquotesingle{}s context, the plug-\/in\textquotesingle{}s host-\/side code uses unique identifiers generated with the \mbox{\hyperlink{a00410_acf807247ecd6e5899dc9dc31644e9a1d}{AAX\+\_\+\+FIELD\+\_\+\+INDEX}} macro\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{enum} EDemoDist\_Alg\_PortID}
\DoxyCodeLine{\{}
\DoxyCodeLine{     eAlgPortID\_BypassIn                    = \mbox{\hyperlink{a00410_acf807247ecd6e5899dc9dc31644e9a1d}{AAX\_FIELD\_INDEX}} (SDemoDist\_Alg\_Context, mCtrlBypassP)}
\DoxyCodeLine{    ,eAlgPortID\_MixIn                       = \mbox{\hyperlink{a00410_acf807247ecd6e5899dc9dc31644e9a1d}{AAX\_FIELD\_INDEX}} (SDemoDist\_Alg\_Context, mCtrlMixP)}
\DoxyCodeLine{    ,eAlgPortID\_InpGIn                      = \mbox{\hyperlink{a00410_acf807247ecd6e5899dc9dc31644e9a1d}{AAX\_FIELD\_INDEX}} (SDemoDist\_Alg\_Context, mCtrlInpGP)}
\DoxyCodeLine{    ,eAlgPortID\_OutGIn                      = \mbox{\hyperlink{a00410_acf807247ecd6e5899dc9dc31644e9a1d}{AAX\_FIELD\_INDEX}} (SDemoDist\_Alg\_Context, mCtrlOutGP)}
\DoxyCodeLine{    ,eAlgPortID\_CoefsDistIn                 = \mbox{\hyperlink{a00410_acf807247ecd6e5899dc9dc31644e9a1d}{AAX\_FIELD\_INDEX}} (SDemoDist\_Alg\_Context, mCoefsDistP)}
\DoxyCodeLine{    ,eAlgPortID\_CoefsFilterIn               = \mbox{\hyperlink{a00410_acf807247ecd6e5899dc9dc31644e9a1d}{AAX\_FIELD\_INDEX}} (SDemoDist\_Alg\_Context, mCoefsFiltP)}
\DoxyCodeLine{}
\DoxyCodeLine{    ,eAlgFieldID\_Biquads                    = \mbox{\hyperlink{a00410_acf807247ecd6e5899dc9dc31644e9a1d}{AAX\_FIELD\_INDEX}} (SDemoDist\_Alg\_Context, mBiquads)}
\DoxyCodeLine{}
\DoxyCodeLine{    ,eDemoDist\_AlgFieldID\_AudioIn           = \mbox{\hyperlink{a00410_acf807247ecd6e5899dc9dc31644e9a1d}{AAX\_FIELD\_INDEX}} (SDemoDist\_Alg\_Context, mInputPP)}
\DoxyCodeLine{    ,eDemoDist\_AlgFieldID\_AudioOut          = \mbox{\hyperlink{a00410_acf807247ecd6e5899dc9dc31644e9a1d}{AAX\_FIELD\_INDEX}} (SDemoDist\_Alg\_Context, mOutputPP)}
\DoxyCodeLine{    ,eAlgFieldID\_MeterTaps                  = \mbox{\hyperlink{a00410_acf807247ecd6e5899dc9dc31644e9a1d}{AAX\_FIELD\_INDEX}} (SDemoDist\_Alg\_Context, mMeterTapsPP)}
\DoxyCodeLine{\};}

\end{DoxyCode}


 See \mbox{\hyperlink{a00889}{Description callback}} for more information about registering context fields and defining a plug-\/in\textquotesingle{}s message routing scheme. 

 \hypertarget{a00890_alg_initialization}{}\doxysubsection{Algorithm initialization}\label{a00890_alg_initialization}
 The following events occur before the AAX host begins calling a plug-\/in\textquotesingle{}s algorithm\+:

 \begin{DoxyItemize}
\item The Effect\textquotesingle{}s \mbox{\hyperlink{a00891}{data model}} is initialized \item An initial call to \mbox{\hyperlink{a02068_a6e87e40d42c7431e52ae5ebd4f631964}{AAX\+\_\+\+IEffect\+Parameters\+::\+Reset\+Field\+Data()}} is made for each private data block in the algorithm. \item An initial call to \mbox{\hyperlink{a02068_a083265b008921b6114ede387711694b7}{AAX\+\_\+\+IEffect\+Parameters\+::\+Generate\+Coefficients()}} is made and coefficient packets are dispatched to each of the algorithm\textquotesingle{}s data ports based on the default model state. \item All packets are delivered and initial algorithm context state is set \item If one has been registered, the algorithm\textquotesingle{}s optional initialization callback is called with the default context \item (Algorithmic processing begins)\end{DoxyItemize}
\hypertarget{a00890_alg_initialization_private_data}{}\doxysubsubsection{Private data initialization}\label{a00890_alg_initialization_private_data}
 To initialize an algorithm\textquotesingle{}s private data blocks, \mbox{\hyperlink{a02068_a6e87e40d42c7431e52ae5ebd4f631964}{AAX\+\_\+\+IEffect\+Parameters\+::\+Reset\+Field\+Data()}} is called on the host for each block in the algorithm. The host uses this method to acquire a default initialized memory block for each private data port, which is then copied into the algorithm\textquotesingle{}s memory pool and provided to its context.

 The default implementation of this method in \mbox{\hyperlink{a01852_a0dd675680a657de7f9d45d65d4b3bcfb}{AAX\+\_\+\+CEffect\+Parameters}} will initialize the data to zero.

 \begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{a00890_alg_pd}{Persistent algorithm memory}}
\end{DoxySeeAlso}
\hypertarget{a00890_alg_initialization_optional_callback}{}\doxysubsubsection{Optional initialization callback}\label{a00890_alg_initialization_optional_callback}
 ...
 This initialization routine is provided in \mbox{\hyperlink{a00889}{Describe}} as an argument to the platform\textquotesingle{}s {\ttfamily Add\+Process\+Proc} registration method\+:

 \begin{DoxyItemize}
\item \mbox{\hyperlink{a02216_a1c069508cf54a523905c8160ebf628ad}{AAX\+\_\+\+IComponent\+Descriptor\+::\+Add\+Process\+Proc\+\_\+\+Native()}} \item \mbox{\hyperlink{a02216_aa8443e720e48046444a2e9f712f0864b}{AAX\+\_\+\+IComponent\+Descriptor\+::\+Add\+Process\+Proc\+\_\+\+TI()}}\end{DoxyItemize}
\begin{DoxyRefDesc}{Host Compatibility Notes}
\item[\mbox{\hyperlink{a00879__compatibility_notes000003}{Host Compatibility Notes}}]As of Pro Tools 10.\+2.\+1 an algorithm\textquotesingle{}s initialization calllback routine will have up to 5 seconds to execute.\end{DoxyRefDesc}
...
\end{DoxySeeAlso}
 ...
 \hypertarget{a00890_alg_processing}{}\doxysubsection{Algorithm processing}\label{a00890_alg_processing}
...
\end{DoxyNote}
 ...
 \hypertarget{a00890_alg_pd}{}\doxysubsection{Persistent algorithm memory}\label{a00890_alg_pd}
...
\hypertarget{a00890_alg_pd_characteristics}{}\doxysubsubsection{Private memory characteristics}\label{a00890_alg_pd_characteristics}
 ...
 Once private data is allocated by the plug-\/in host or DSP shell, it will not be relocated or re-\/allocated until the algorithm is destroyed (see \mbox{\hyperlink{a00890_alg_initialization_optional_callback}{Optional initialization callback}})

\hypertarget{a00890_alg_pd_registration}{}\doxysubsubsection{Private data port registration}\label{a00890_alg_pd_registration}
 Private data ports are registered during Describe via \mbox{\hyperlink{a02216_a125949841a13e97ff93fa321f2050433}{AAX\+\_\+\+IComponent\+Descriptor\+::\+Add\+Private\+Data()}}. This method defines the size of the data block that will be allocated as well as an initialization callback with format \mbox{\hyperlink{a00419_adfb5d89b9d957c541fc98fe42bc050c4}{AAX\+\_\+\+CInit\+Private\+Data\+Proc}}.

\hypertarget{a00890_alg_pd_init}{}\doxysubsubsection{Private data initialization}\label{a00890_alg_pd_init}
 \mbox{\hyperlink{a02068_a6e87e40d42c7431e52ae5ebd4f631964}{AAX\+\_\+\+IEffect\+Parameters\+::\+Reset\+Field\+Data()}} is called on the host for both Native and DSP plug-\/ins. For DSP plug-\/ins, the initialized data block is copied to the DSP by the AAX host following the initialization callback. The initialization callbacks for a plug-\/in\textquotesingle{}s private data blocks are called after all host modules have been initialized and before the algorithm\textquotesingle{}s optional initialization callback.

 \begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{a00890_alg_initialization}{Algorithm initialization}}
\end{DoxySeeAlso}
\hypertarget{a00890_alg_pd_comm}{}\doxysubsubsection{Private data communication}\label{a00890_alg_pd_comm}
 It is possible to transfer data to and from the algorithm\textquotesingle{}s private data blocks using the \mbox{\hyperlink{a02312}{AAX\+\_\+\+IPrivate\+Data\+Access}} interface, which is available in a Timer\+Wakeup context through the \mbox{\hyperlink{a02260}{AAX\+\_\+\+IEffect\+Direct\+Data}} interface. For more information about this API, see auxinterface\+\_\+directdata\+\_\+privatedataaccess.



 \hypertarget{a00890_alg_examp}{}\doxysubsection{Example algorithm callback}\label{a00890_alg_examp}
...
\end{DoxyCode}
 ...
 \hypertarget{a00890_alg_porttypes}{}\doxysubsection{Port Types and Behavior}\label{a00890_alg_porttypes}
...
\hypertarget{a00890_subsection__standard_message_input}{}\doxysubsubsection{Standard message input}\label{a00890_subsection__standard_message_input}
...
To define a standard message input port, a plug-\/in should call \mbox{\hyperlink{a02216_a230293b9f6bb413626cd487ca501df75}{AAX\+\_\+\+IComponent\+Descriptor\+::\+Add\+Data\+In\+Port()}}.

\hypertarget{a00890_subsection__internal_state_storage}{}\doxysubsubsection{Internal state storage}\label{a00890_subsection__internal_state_storage}
...
A component that has registered a private data field is given access to a block of private data. Although the memory in this block will be allocated by the host, its data is fully owned by the component. Because this data is considered private to its parent component, other components cannot overwrite or target this data. Plug-\/ins that need to transmit data directly between their algorithms\textquotesingle{} private data ports and their other modules may use the \mbox{\hyperlink{a02260}{AAX\+\_\+\+IEffect\+Direct\+Data}} interface, which provides an API for reading from or writing to this data from outside of the algorithm callback.
...
\hypertarget{a00890_subsection__metering_output}{}\doxysubsubsection{Metering output}\label{a00890_subsection__metering_output}
...
\hypertarget{a00890_subsection__environment_variable_retrieval}{}\doxysubsubsection{Environment variable retrieval}\label{a00890_subsection__environment_variable_retrieval}
...
\hypertarget{a00890_subsection__other_functionality_enhancement}{}\doxysubsubsection{Other functionality enhancement}\label{a00890_subsection__other_functionality_enhancement}
An algorithm component may use ports to gain additional functionality that is provided by the host. For example, an algorithm that will be compiled for accelerated environments may take advantage of the TI chip\textquotesingle{}s Direct Memory Access functionality by registering a DMA port. The host will then allow this port to access memory directly using \mbox{\hyperlink{a00950}{AAX}}\textquotesingle{}s DMA APIs.



 \hypertarget{a00890_alg_seealso}{}\doxysubsection{Additional Information}\label{a00890_alg_seealso}
 For information about optional features for the algorithm processing callback, see the following \mbox{\hyperlink{a00896}{Additional AAX features}} documentation\+:

 \begin{DoxyItemize}
\item \mbox{\hyperlink{a00899}{Direct Memory Access}} \item \mbox{\hyperlink{a00898}{Background processing callback}}\end{DoxyItemize}
