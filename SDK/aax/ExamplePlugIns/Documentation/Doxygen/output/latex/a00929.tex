\hypertarget{a00929}{}\doxysection{Media Composer Guide}
\label{a00929}\index{Media Composer Guide@{Media Composer Guide}}
Details about using AAX plug-\/ins in Media Composer. 

\hypertarget{a00929_aax_media_composer_guide_contents}{}\doxysubsection{Contents}\label{a00929_aax_media_composer_guide_contents}
\begin{DoxyItemize}
\item \mbox{\hyperlink{a00929_aax_media_composer_guide__about_this_document}{About this document}} \item \mbox{\hyperlink{a00929_aax_media_composer_guide__processing_modes}{Processing modes}} \item \mbox{\hyperlink{a00929_aax_media_composer_guide__requirements}{Compatibility requirements}} \item \mbox{\hyperlink{a00929_aax_media_composer_guide__features}{AAX feature support in Media Composer}} \item \mbox{\hyperlink{a00929_aax_media_composer_guide__additional_information}{Additional Information}}\end{DoxyItemize}
 \hypertarget{a00929_aax_media_composer_guide__about_this_document}{}\doxysubsection{About this document}\label{a00929_aax_media_composer_guide__about_this_document}
...
For more information about the features, functionality, and use of Media Composer see the Media Composer user documentation. 
 ...
 \hypertarget{a00929_aax_media_composer_guide__processing_modes}{}\doxysubsection{Processing modes}\label{a00929_aax_media_composer_guide__processing_modes}
...
\hypertarget{a00929_subsection__media_composer_guide__audiosuite}{}\doxysubsubsection{Non-\/real-\/time processing (\+Audio\+Suite)}\label{a00929_subsection__media_composer_guide__audiosuite}
...
\hypertarget{a00929_subsubsection__media_composer_guide__audiosuite_apply_to_clip}{}\doxyparagraph{Applying an Audio\+Suite Plug-\/in to a Clip in the Timeline}\label{a00929_subsubsection__media_composer_guide__audiosuite_apply_to_clip}
...
\hypertarget{a00929_subsubsection__media_composer_guide__audiosuite_master_clip_mode}{}\doxyparagraph{Audio\+Suite Master Clip Mode}\label{a00929_subsubsection__media_composer_guide__audiosuite_master_clip_mode}
...
\hypertarget{a00929_subsubsection__media_composer_guide__audiosuite_restrictions}{}\doxyparagraph{Restrictions on Audio\+Suite processing}\label{a00929_subsubsection__media_composer_guide__audiosuite_restrictions}
 
\begin{DoxyItemize}
\item Media Composer does not support width-\/changing Audio\+Suite effects except in \mbox{\hyperlink{a00929_subsubsection__media_composer_guide__audiosuite_master_clip_mode}{Master Clip Mode}}. See \mbox{\hyperlink{a00929_subsection__aax_media_composer_guide__features__processing}{Processing configurations}} for more information about supported stem formats in Media Composer.  
\item Audio\+Suite effects that change the clip length should only be used in \mbox{\hyperlink{a00929_subsubsection__media_composer_guide__audiosuite_master_clip_mode}{Master Clip Mode}}, because consolidated sequences will not consolidate the correct media length. 
\end{DoxyItemize}

\hypertarget{a00929_subsection__real-time_processing}{}\doxysubsubsection{Real-\/time processing}\label{a00929_subsection__real-time_processing}
...
Real-\/time AAX processing in Media Composer is analogous to the track inserts feature in Pro Tools. For more information about track inserts in Pro Tools, see the \mbox{\hyperlink{a00928_subsection__realtime_processing}{Real-\/time processing}} section in the \mbox{\hyperlink{a00928}{Pro Tools Guide}}.

\hypertarget{a00929_subsubsectin__media_composer_guide__inserting_real-time}{}\doxyparagraph{Creating and accessing real-\/time plug-\/in instances}\label{a00929_subsubsectin__media_composer_guide__inserting_real-time}
...
\hypertarget{a00929_subsubsectin__media_composer_guide__using_templates}{}\doxyparagraph{Using Audio Track Effect Templates}\label{a00929_subsubsectin__media_composer_guide__using_templates}
...
This applies the effect to the track.
 ...
 \hypertarget{a00929_aax_media_composer_guide__requirements}{}\doxysubsection{Compatibility requirements}\label{a00929_aax_media_composer_guide__requirements}
...
\hypertarget{a00929_subsection__media_composer_guide__install_directories}{}\doxysubsubsection{Install directories}\label{a00929_subsection__media_composer_guide__install_directories}
...
\hypertarget{a00929_subsection__media_composer_guide__file_name}{}\doxysubsubsection{Plug-\/in name and file structure}\label{a00929_subsection__media_composer_guide__file_name}
...
The directory structure of an AAX plug-\/in bundle is also important. See \mbox{\hyperlink{a00895_commoninterface_formatspecification__aaxplugin_directory_structure}{.aaxplugin Directory Structure}} in the \mbox{\hyperlink{a00895}{AAX Format Specification}} document for more information.
 ...
 \hypertarget{a00929_aax_media_composer_guide__features}{}\doxysubsection{AAX feature support in Media Composer}\label{a00929_aax_media_composer_guide__features}
...
\hypertarget{a00929_subsection__aax_media_composer_guide__features__processing}{}\doxysubsubsection{Processing configurations}\label{a00929_subsection__aax_media_composer_guide__features__processing}
...
\hypertarget{a00929_subsection__aax_media_composer_guide__features__presets}{}\doxysubsubsection{Preset management}\label{a00929_subsection__aax_media_composer_guide__features__presets}
...
\hypertarget{a00929_subsubsection__aax_media_composer_guide__features__presets__persistence_notes}{}\doxyparagraph{Plug-\/in preset compatibility and persistance}\label{a00929_subsubsection__aax_media_composer_guide__features__presets__persistence_notes}
...
\hypertarget{a00929_subsubsection__aax_media_composer_guide__features__presets__comparison}{}\doxyparagraph{Plug-\/in preset data comparison}\label{a00929_subsubsection__aax_media_composer_guide__features__presets__comparison}
 Media Composer\textquotesingle{}s rendered Audio\+Suite effect feature relies on a comparison of plug-\/in settings chunk data. Unlike in Pro Tools, this operation uses direct data comparison rather than \mbox{\hyperlink{a02068_a1e86f849e970c9998313fc7d451ccf85}{AAX\+\_\+\+IEffect\+Parameters\+::\+Compare\+Active\+Chunk()}}. Therefore, Media Composer compatibility and proper operation of Audio\+Suite rendering in Media Composer depends on the plug-\/in having fully consistent AAX preset contents from one run to the next.
...
\hypertarget{a00929_subsection__aax_media_composer_guide__features__unsupported}{}\doxysubsubsection{Unsupported features}\label{a00929_subsection__aax_media_composer_guide__features__unsupported}
...
\begin{DoxyItemize}
\item Advanced audio routing  Media Composer has a simplified audio topology with only tracks and a single master fader. There are no side chains, no busses, and no submasters. As a result, Media Composer does not support extended routing options such as \mbox{\hyperlink{a00907}{Sidechain Inputs}} or \mbox{\hyperlink{a00897}{Auxiliary Output Stems}}  
\item Transport interface  Media Composer does not fully support the \mbox{\hyperlink{a02352}{AAX\+\_\+\+ITransport}} interface. In addition, early versions of Media Composer 8 that do not support this interface at all may incorrectly return \mbox{\hyperlink{a00530_a5f8c7439f3a706c4f8315a9609811937aeddbd1bb67e3a66e6af54a4b4a7a57b3}{AAX\+\_\+\+SUCCESS}} to method calls on this interface. More recent versions of Media Composer will either provide valid information or return \mbox{\hyperlink{a00530_a5f8c7439f3a706c4f8315a9609811937a3b76994b32b97fcd56b19ef8032245df}{AAX\+\_\+\+ERROR\+\_\+\+UNIMPLEMENTED}}.  
\item MIDI  Media Composer does not support MIDI routing to and from plug-\/in instances, and no \mbox{\hyperlink{a00904}{AAX MIDI features}} are supported by Media Composer.  
...
\hypertarget{a00929_subsection__aax_media_composer_guide__features__additional_notes}{}\doxysubsubsection{Additional feature support notes}\label{a00929_subsection__aax_media_composer_guide__features__additional_notes}
 
\begin{DoxyItemize}
\item \mbox{\hyperlink{a00950}{AAX}} plug-\/in notification support varies between Media Composer and Pro Tools. Media Composer does not support the following notifications, and may not support additional notifications as well\+: \begin{DoxyItemize}
\item \mbox{\hyperlink{a00524_afab5ea2cfd731fc8f163b6caa685406eaa55c7e25741c0d4f81cc49394e96a43c}{AAX\+\_\+e\+Notification\+Event\+\_\+\+ASProcessing\+State}} \item \mbox{\hyperlink{a00524_afab5ea2cfd731fc8f163b6caa685406ea8ca3f7d5e93eecf945682f6fc55f5263}{AAX\+\_\+e\+Notification\+Event\+\_\+\+ASPreview\+State}}. \item \mbox{\hyperlink{a00524_afab5ea2cfd731fc8f163b6caa685406ea013a21c2c111bac54b962b40f1b4bc1f}{AAX\+\_\+e\+Notification\+Event\+\_\+\+Session\+Being\+Opened}}\end{DoxyItemize}



\item Media Composer does not support Audio\+Suite rendering to a separate track (see \mbox{\hyperlink{a00737_a13e384f22825afd3db6d68395b79ce0dadd8839e5678c8880215e318197cc8d3a}{AAX\+\_\+e\+Property\+\_\+\+Destination\+Track}})  
\end{DoxyItemize}



 \hypertarget{a00929_aax_media_composer_guide__additional_information}{}\doxysubsection{Additional Information}\label{a00929_aax_media_composer_guide__additional_information}
 \hypertarget{a00929_subsection__aax_media_composer_guide__audio_engine}{}\doxysubsubsection{Audio Engine features and behavior}\label{a00929_subsection__aax_media_composer_guide__audio_engine}
...
For more detailed information about how AAE handles plug-\/in loading and processing, see \mbox{\hyperlink{a00928_aax_pro_tools_guide__audio_engine_behavior}{Audio Engine Behavior and Features}} in the \mbox{\hyperlink{a00928}{Pro Tools Guide}}.

\hypertarget{a00929_subsection__aax_media_composer_guide__debugging}{}\doxysubsubsection{Debugging AAX plug-\/ins in Media Composer}\label{a00929_subsection__aax_media_composer_guide__debugging}
...
For more information about debugging in Pro Tools and Digi\+Shell, see \mbox{\hyperlink{a00928_aax_pro_tools_guide__debugging_aax_plugins}{Debugging AAX plug-\/ins}} in the \mbox{\hyperlink{a00928}{Pro Tools Guide}}.
