...
/**  
 *	\file AAX_EnvironmentUtilities_UnitTest_Linux.cpp
 *
 *	\brief Unit tests for AAX_EnvironmentUtilities.h Linux environment detection
 *
 */ 
/*================================================================================================*/
...
// Mock Linux environment definitions with C++14 support
#define __linux__ 1
#define __cplusplus 201402L  // C++14 support

// If the compiler does not allow redefining these macros, skip the test
#if (defined(__linux__) && (__linux__ == 1)) && (defined(__cplusplus) && (__cplusplus == 201402L))

#include "AAX_EnvironmentUtilities.h"

//--------------------------------------------------------------------
#pragma mark - Linux Environment Preprocessor Tests
...
// AAX_CPP11_SUPPORT should be defined as 1 with __cplusplus >= 201103L
#ifndef AAX_CPP11_SUPPORT
#error "AAX_CPP11_SUPPORT should be defined with __cplusplus >= 201103L"
#endif

#if AAX_CPP11_SUPPORT != 1
#error "AAX_CPP11_SUPPORT should be 1 with __cplusplus >= 201103L"
#endif
