...
/**  
 *	\file AAX_EnvironmentUtilities_UnitTest_Mac.cpp
 *
 *	\brief Unit tests for AAX_EnvironmentUtilities.h Mac environment detection
 *
 */ 
/*================================================================================================*/
...
// Mock Mac environment definitions with C++17 support
#define __APPLE__ 1
#define __MACH__ 1
#define __cplusplus 201703L  // C++17 support
#define TARGET_OS_MAC 1

// If the compiler does not allow redefining these macros, skip the test
#if (defined(__APPLE__) && (__APPLE__ == 1)) && (defined(__MACH__) && (__MACH__ == 1)) && (defined(__cplusplus) && (__cplusplus == 201703L)) && (defined(TARGET_OS_MAC) && (TARGET_OS_MAC == 1))

#include "AAX_EnvironmentUtilities.h"

//--------------------------------------------------------------------
#pragma mark - Mac Environment Preprocessor Tests
...
// AAX_CPP11_SUPPORT should be defined as 1 with C++17
#ifndef AAX_CPP11_SUPPORT
#error "AAX_CPP11_SUPPORT should be defined with C++17"
#endif

#if AAX_CPP11_SUPPORT != 1
#error "AAX_CPP11_SUPPORT should be 1 with C++17"
#endif
