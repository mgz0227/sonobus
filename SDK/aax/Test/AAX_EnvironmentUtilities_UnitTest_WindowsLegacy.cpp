...
/**  
 *	\file AAX_EnvironmentUtilities_UnitTest_WindowsLegacy.cpp
 *
 *	\brief Preprocessor tests for AAX_EnvironmentUtilities.h Windows legacy environment
 *
 */ 
/*================================================================================================*/
...
// Mock Windows legacy environment definitions (no C++11 support)
#define _WIN32 1
...
#if (defined(_WIN32) && (_WIN32 == 1)) && (defined(_MSVC_LANG) && (_MSVC_LANG == 201103L))

#include "AAX_EnvironmentUtilities.h"

//--------------------------------------------------------------------
#pragma mark - Windows Legacy Environment Preprocessor Tests
...
// AAX_CPP11_SUPPORT should not be defined with _MSVC_LANG < 201402L
#ifdef AAX_CPP11_SUPPORT
#if AAX_CPP11_SUPPORT != 0
#error "AAX_CPP11_SUPPORT should be 0 with _MSVC_LANG < 201402L"
#endif
#endif

// TI_VERSION should not be defined in Windows legacy environment
#ifdef TI_VERSION
